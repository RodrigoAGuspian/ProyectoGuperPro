...
class Persona(models.Model):
	...
	imgPerfil = models.ImageField(upload_to = 'img_perfil', null=True, blank=True, default='img_perfil/imgDefault.jpg' )
...
class Ficha(models.Model):
	...
	def __str__(self):
		return self.numeroFicha+' _ '+self.programa.abreviacion
#=================================================#
