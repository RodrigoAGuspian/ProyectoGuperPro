# Generated by Django 2.0.4 on 2018-05-29 18:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imgPerfil', models.ImageField(blank=True, null=True, upload_to='img_perfil')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rol', models.CharField(choices=[('APRENDIZ', 'APRENDIZ'), ('INSTRUCTOR', 'INSTRUCTOR'), ('ADMINISTRADOR', 'ADMINISTRADOR'), ('VIGILANTE', 'VIGILANTE')], max_length=20, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Rol_persona',
